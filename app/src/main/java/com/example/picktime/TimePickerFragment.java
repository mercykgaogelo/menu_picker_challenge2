...
//    public View onCreateView(LayoutInflater inflater, ViewGroup container,
   ...
   public Dialog onCreateDialog(Bundle savedInstanceState) {
      ...
      // return hour, minute
       ...
       //return  new TimePickerDialog(getShowsDialog(),this,hour);
return new TimePickerDialog(getActivity(),this, hour,minute,is24HoursView);
     //  return new TimePickerDialog().set
   }
